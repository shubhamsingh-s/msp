...
async function seed() {
  ...
  if (!host || !user || !database) {
    console.error('Error: Database configuration environment variables are not set in .env');
    console.log('Please check your .env file or environment settings.');
    process.exit(1);
  }
  ...
  try {
    ...
    if (admins[0].count === 0) {
      ...
      console.log('✅ Seeded default administrator: admin@mspbharat.com / admin123');
    } else {
      console.log('ℹ️ Admin table already contains data. Skipped admin seeding.');
    }
    ...
    if (categories[0].count === 0) {
      ...
      console.log('ℹ️ Categories table already contains data. Skipped category seeding.');
    }
    ...
    if (products[0].count === 0) {
      ...
      console.log('ℹ️ Products table already contains data. Skipped products seeding.');
    }
